...
let contractAddress = "0x86488C41A86E337a1abED3e76Abcc3B56Ad5d030";
let contractAbi= [
    {
      "inputs": [
        {
...
console.log("Connected to MetaMask:", WALLET_CONNECTED);
}
...
const getAllCandidates = async() => {
    if(WALLET_CONNECTED != 0) {
        ...
        p3.innerHTML = "The candidate list are updated"
    }
    else {
        var p3 = document.getElementById("p3");
